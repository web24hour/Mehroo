        ...
        <div class="container container-content">
                        ...
                        <div class="flex product-img-slide">
                            <div class="product-images">
                                ...
                                <div class="main-img js-product-slider">
                                    <a href="#" class="hover-images effect"><img src="img/product/single_1a.jpg" alt="photo" class="img-responsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/product/single_2a.jpg" alt="photo" class="img-responsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/product/single_3a.jpg" alt="photo" class="img-responsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/product/single_4a.jpg" alt="photo" class="img-responsive"></a>
                                    <a href="#" class="hover-images effect"><img src="img/product/single_5a.jpg" alt="photo" class="img-responsive"></a>
                                </div>
                            </div>
            ...
            <div class="single-product-tab bd-bottom">
                <ul class="tabs text-center">
                    <li><a data-toggle="pill" href="#desc">Description</a></li>
                    <li class="active"><a data-toggle="pill" href="#review">Reviews <span class="review-number">2</span></a></li>
                </ul>
                <div class="tab-content">
                    <div id="desc" class="tab-pane fade in ">
                        <div class="content-desc text-center">
                            <p>
                                Add a British twist to your wardrobe with the Erika skirt in seersucker. Pinstripe pattern. 2 patched front pockets. Waist tie belt with loops. Button detailing on the front. Integrated cotton lining.
                            </p>
                            <p>
